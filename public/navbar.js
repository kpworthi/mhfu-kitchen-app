const NavBar = ({
  ...
  const apps = {
    weapons: {
      ...
      subs: ["Sword and Shield", "Dual Blades", "Great Sword", "Long Sword", "Hunting Horn", "Hammer", "Gunlance", "Lance", "Bow"]
    },
    kitchen: {
      title: "Kitchen",
  ...
  const buildDropdown = type => {
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: "dropdown-wrapper mx-1"
    }, /*#__PURE__*/React.createElement("div", {
      id: `${type}-dropdown`,
      className: "nav-drop",
      onClick: clickHandler
    }, /*#__PURE__*/React.createElement("div", {
      className: "h1 title dropdown-curr"
    }, /*#__PURE__*/React.createElement("span", {
      tabIndex: "0",
      className: "dropdown-title",
      id: `${type}-title`
    }, `${type === "app" ? "+" : ":"} ${options[0]}`)), /*#__PURE__*/React.createElement("div", {
      className: "dropdown-opt-list border border-top-0 border-dark"
      ...
      return /*#__PURE__*/React.createElement("span", {
        className: "h1 title my-0 mx-1 dropdown-opt",
        tabIndex: "0",
        key: `opt-${val}`
      }, `- ${val}`);
    }))));
  ...
  return /*#__PURE__*/React.createElement("div", {
    id: "nav-bar",
    className: "d-flex flex-wrap justify-content-between align-items-center border border-dark mb-2"
  }, /*#__PURE__*/React.createElement("nav", {
    className: "m-0 row"
  }, buildDropdown("app"), buildDropdown("sub")), /*#__PURE__*/React.createElement("span", {
    className: "h3 px-3 tag-line"
  }, tagLine));
};
